...
ggsave("Figures/Supplemental/FigureS7_YR-I_grid.png", width = 6.25, height = 5.5, units = "in", dpi = 500)
chemo_hydro_graph(SMC_d, SMC_ts_mass, "Sixmile Creek")
ggsave("Figures/Supplemental/FigureS6_SMC_grid.png", width = 6.25, height = 5.5, units = "in", dpi = 500)
chemo_hydro_graph(DC_d, DC_ts_mass, "Dorn Creek")
ggsave("Figures/Supplemental/FigureS3_DC_grid.png", width = 6.25, height = 5.5, units = "in", dpi = 500)
chemo_hydro_graph(PB_d, PB_ts_mass, "Pheasant Branch Creek")
ggsave("Figures/Supplemental/FigureS4_PB_grid.png", width = 6.25, height = 5.5, units = "in", dpi = 500)
chemo_hydro_graph(YRO_d, YRO_ts_mass, "Yahara River Outflow")
ggsave("Figures/Supplemental/FigureS8_YR-O_grid.png", width = 6.25, height = 5.5, units = "in", dpi = 500)
chemo_hydro_graph(SH_d, SH_ts_mass, "Spring Harbor")
ggsave("Figures/Supplemental/FigureS5_SH_grid.png", width = 6.25, height = 5.5, units = "in", dpi = 500)
